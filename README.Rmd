...
Which population model shows a quantitatively improved association between an adverse event with a drug exposure as it is reported at and across child developmental stages?
...
I made an R package that stores the FDA's reports collected from clinical trials, lawyers, doctors, pharma companies, etc., specifically on the occurrence of Methylphenidate exposure and Paranoia. This is a known adverse drug effect^[1](http://doi.wiley.com/10.1111/j.1475-3588.2008.00490.x),[2](http://pediatrics.aappublications.org/cgi/doi/10.1542/peds.2008-0185)^, with a mechanism of inhibiting dopamine neurons^[3](http://link.springer.com/10.1007/s11065-006-9017-3)^ and having long term side effects such as a change in brain chemistry and signaling^[4](https://linkinghub.elsevier.com/retrieve/pii/S0197018618303905)^.
